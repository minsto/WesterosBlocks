...
import com.mickdev.wm.item.ItemLogo;
...
public class ModItems2 {
   ...
   */
  public static ItemLogo logotest;
  ...
  public static void init() {
    ...
    // the most sense to you.
	  logotest= new ItemLogo();
    // Setting the registry name is how Forge tells items apart.
    logotest.setRegistryName(new ResourceLocation(werterbrosblock.MOD_ID, Names.LOGO_ITEM));
    // Finally, register the item! Must be done AFTER setting the registry name.
    GameRegistry.register(logotest);
  ...
  public static void initClient(ItemModelMesher mesher) {
    ...
    mesher.register(logotest, 0, model);
